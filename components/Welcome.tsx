  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-4xl mx-auto px-4 relative">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {[
          { size: 'w-6 h-6', top: '10%', left: '15%', animName: 'starFloat1', duration: '8s', delay: '0s' },
          { size: 'w-5 h-5', top: '20%', left: '80%', animName: 'starFloat2', duration: '10s', delay: '1s' },
          { size: 'w-8 h-8', top: '35%', left: '25%', animName: 'starFloat3', duration: '12s', delay: '2s' },
          { size: 'w-6 h-6', top: '50%', left: '70%', animName: 'starFloat4', duration: '9s', delay: '0.5s' },
          { size: 'w-7 h-7', top: '65%', left: '10%', animName: 'starFloat5', duration: '11s', delay: '1.5s' },
          { size: 'w-5 h-5', top: '75%', left: '85%', animName: 'starFloat1', duration: '8s', delay: '2.5s' },
          { size: 'w-6 h-6', top: '85%', left: '40%', animName: 'starFloat2', duration: '10s', delay: '1s' },
          { size: 'w-6 h-6', top: '5%', left: '50%', animName: 'starFloat3', duration: '12s', delay: '0s' },
          { size: 'w-6 h-6', top: '30%', left: '90%', animName: 'starFloat4', duration: '9s', delay: '1.5s' },
          { size: 'w-5 h-5', top: '60%', left: '5%', animName: 'starFloat5', duration: '11s', delay: '2s' },
          { size: 'w-8 h-8', top: '40%', left: '60%', animName: 'starFloat1', duration: '8s', delay: '0.5s' },
          { size: 'w-6 h-6', top: '15%', left: '35%', animName: 'starFloat2', duration: '10s', delay: '1.5s' },
          { size: 'w-6 h-6', top: '55%', left: '95%', animName: 'starFloat3', duration: '12s', delay: '0s' },
          { size: 'w-5 h-5', top: '70%', left: '30%', animName: 'starFloat4', duration: '9s', delay: '2s' },
          { size: 'w-7 h-7', top: '25%', left: '55%', animName: 'starFloat5', duration: '11s', delay: '1s' },
        ].map((star, i) => (
          <div
            key={i}
          ...
          >
            <svg
              ...
              style={{ filter: 'drop-shadow(0 0 4px rgba(255, 255, 255, 0.8)) drop-shadow(0 0 8px rgba(255, 255, 255, 0.4))' }}
            >
              <path
        ...
        {[
          ...
          >
            <svg
              ...
              fill="none"
              className="w-full h-full text-white"
              style={{ filter: 'drop-shadow(0 0 3px rgba(255, 255, 255, 0.7)) drop-shadow(0 0 6px rgba(255, 255, 255, 0.3))' }}
            >
              <path
